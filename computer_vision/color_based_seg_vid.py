...
while(vid_cap.isOpened()):
    ...
    if ret:
        ...
        imgEroded = cv2.erode(maskHSV, kernel, iterations=2)
        imgDilated = cv2.dilate(imgEroded, kernel, iterations=4) #we used those filters to smooth the mask for a better detection
